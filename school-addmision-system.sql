...
insert  into `student`(`roll_no`,`address`,`admission_date`,`course`,`name`,`phone_no`)
values (7,'Sergey',NULL,3,'Bondarenko',12365894165),(8,'Kramarchuk','2012-05-02 11:22:29',2,'Anatoliy',1235648974521),
(9,'Serov','2012-05-02 11:24:07',7,'Anton',5865985555);
