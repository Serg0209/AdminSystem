...
<hr color="#FFD699">
<h2 align="center" bgcolor="#FFD699">Student Search Form</h2>
<hr color="#FFD699">
<center>
    <form:form id="studentSearchForm" name="studentSearchForm" action="search" method="POST"
    ...
    <table cellspacing="5" cellpadding="5" bgcolor="#F0FFC2" width="700">
        ...
        <tr>
            <td><a style="text-decoration: none; color: black;"
                   href="load-student-form?id=${student.rollNo}">${student.rollNo}</a></td>
            <td><a style="text-decoration: none; color: black;"
                   href="load-student-form?id=${student.rollNo}">${student.name}</a></td>
            <td>
                ...
                <a style="text-decoration: none; color: black;"
                   href="../view-cources?id=${student.course}"><%= jdbc.getCourseTitle(cId)%>
                </a>
            </td>
            <td>${student.phoneNo}</td>
            <td>${student.address}</td>
            <td bgcolor="#F0F0FF" align="center"><a style="text-decoration: none; color: black;"
                                                    href="delete-student?id=${student.rollNo}">Delete</a></td>
        </tr>
        </c:forEach>
    </table>
    <%
